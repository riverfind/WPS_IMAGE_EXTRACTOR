...
- 双击右侧预览栏：打开独立图片查看器
- 查看器打开时会把焦点切到查看器本身
- 查看器内左 / 右方向键：切换上一张 / 下一张当前可见图片
- 查看器内 `h` / `l`：Vim 式切换上一张 / 下一张当前可见图片
- 查看器切图时，主窗口右侧预览栏、主缩略图区焦点和滚动位置会同步切换到同一张图片
- 查看器内 `Enter`：定位当前图片到文档，查看器保持打开
- 查看器内滚轮：放大 / 缩小
- 查看器内 `Esc`：关闭查看器
...
- 双击右侧预览栏，或按 `O` 键打开查看器
- 查看器打开后，焦点会切到查看器上
- 左 / 右方向键，或 `h` / `l`：切换当前可见图片
- 按 `Enter`：定位当前图片到文档，查看器保持打开
